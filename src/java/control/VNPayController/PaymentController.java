...
public class PaymentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse response)
       ...
       int idEvent = Integer.parseInt(req.getParameter("idEvent"));
        ...
        VolunteerActivity aa = d.getActivityById(idEvent);
        ...
        if (payment.equals("vnpay")) {
            ...
            paydao.insertPayment(Integer.parseInt(vnp_TxnRef), iduser, id, idEvent, "Ung ho:" +aa.getActivityName(), Integer.parseInt(req.getParameter("donation")), 0);;
