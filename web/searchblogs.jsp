                    ...
                    <div id="main" class="s-content__main">
                        ...
                        <ul>
                            <c:if test="${not empty blogs}">
                                <c:forEach var="o" items="${blogs}" varStatus="status">
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    <li class="page-item ${spage == 1 ? 'disabled' : ''}">
                                        <a class="page-link" href="searchblog?spage=1&text=${text}" aria-label="Trang đầu">
                                            <span aria-hidden="true">&laquo;&laquo;</span>
                                        </a>
                                    </li>
                                    <li class="page-item ${spage == 1 ? 'disabled' : ''}">
                                        <a class="page-link" href="searchblog?spage=${spage - 1}&text=${text}" aria-label="Trang trước">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                    <c:forEach var="j" begin="1" step="1" end="${stotalPage}">
                                        <li class="page-item ${spage == j ? 'active' : ''}">
                                            <a class="page-link" href="searchblog?spage=${j}&text=${text}">${j}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item ${spage == stotalPage ? 'disabled' : ''}">
                                        <a class="page-link" href="searchblog?spage=${spage + 1}&text=${text}" aria-label="Trang sau">
                                            <span aria-hidden="true">&raquo;</span>
                                        </a>
                                    </li>
                                    <li class="page-item ${spage == stotalPage ? 'disabled' : ''}">
                                        <a class="page-link" href="searchblog?spage=${stotalPage}&text=${text}" aria-label="Trang cuối">
