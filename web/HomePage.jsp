    ...
    <body>
        ...
        <div class="container-xxl py-5">
                                        ...
                                        <div class="text-center p-4" style="height: 169px;">
                                            ...
                                            <div class="d-flex justify-content-center mb-2">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <a href="login.jsp" class="btn btn-sm btn-primary px-3 " style="border-radius: 30px 30px 30px 30px;">Detail</a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                        </div>
            ...
            <div class="container-xxl py-5 destination">
                <div class="container">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h6 class="section-title bg-white text-center text-primary px-3"> library photo</h6>
                    ...
                    <div class="row g-3">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                                    <a class="position-relative d-block overflow-hidden" href="">
                                        <img class="img-fluid" src="img/tinhnguyen1.jpg" alt="">

                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                                    <a class="position-relative d-block overflow-hidden" href="">
                                        <img class="img-fluid" src="images/volun2.jpg" alt="">

                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                                    <a class="position-relative d-block overflow-hidden" href="">
                                        <img class="img-fluid" src="images/fpt.jpg" alt="">
                        ...
                        <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                            <a class="position-relative d-block h-100 overflow-hidden" href="">
                                <img class="img-fluid position-absolute w-100 h-100" src="images/fpt3.jpg" alt="" style="object-fit: cover;">
                ...
                <div class="container">
                    ...
                    <div class="owl-carousel testimonial-carousel position-relative">
                        <div class="testimonial-item bg-white text-center border p-4">
                            ...
                            <p>New York, USA</p>
                            <p class="mb-0">Thank you, John, for your kind words. We appreciate your support!</p>
                        </div>
                        <div class="testimonial-item bg-white text-center border p-4">
                            <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/testimonial-2.jpg" style="width: 80px; height: 80px;">
                            <h5 class="mb-0">John Doe</h5>
                            <p>New York, USA</p>
                            <p class="mt-2 mb-0">Volunteering allows you to connect with your community and make it a better place. It's a way to give back and help others in need. When you volunteer, you're impacting people's lives for the better</p>
                        </div>
                        <div class="testimonial-item bg-white text-center border p-4">
                            <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/testimonial-3.jpg" style="width: 80px; height: 80px;">
                            <h5 class="mb-0">John Doe</h5>
                            <p>New York, USA</p>
                            <p class="mt-2 mb-0">It can provide a sense of purpose and fulfillment. Volunteering gives you an opportunity to use your skills and talents to make a positive difference. Many volunteers find it very rewarding to know they've helped a cause or person in need.</p>
                        </div>
                        <div class="testimonial-item bg-white text-center border p-4">
                            <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/testimonial-4.jpg" style="width: 80px; height: 80px;">
                            <h5 class="mb-0">John Doe</h5>
                            <p>New York, USA</p>
                            <p class="mt-2 mb-0">You can learn new skills and gain experience. By volunteering you often get exposed to experiences and skills you may not encounter in your daily life. This can help build your resume if you're looking for work.</p>
                        </div>
                    </div>
                </div>
            </div>
